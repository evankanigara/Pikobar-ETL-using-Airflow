...
from scripts_bernard import func
...
with DAG(
    dag_id="etl_covid_jabar_bernard",
    ...
    populate_fact_table_task=PostgresOperator(
        ...
        postgres_conn_id='postgres_default',
        sql='./sql_bernard/populate_fact_table.sql'
    )
